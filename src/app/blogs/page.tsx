...
const BlogsPage = () => {
    return (
        <div className="container max-w-7xl mx-auto py-10">
            <h1 className="text-4xl font-bold mb-4 text-center text-heading">My Blog Posts</h1>
        ...
        {
            blogs.map((blog) =>(
                <article key={blog.slug} className='bg-surface/90 rounded-lg shadow-md p-6 border border-border'>
                    <Link href={`/blogs/${blog.slug}`}>
                    <h3 className='text-xl font-semibold mb-2 text-heading hover:text-primary'>{blog.title}</h3>
                    </Link>
