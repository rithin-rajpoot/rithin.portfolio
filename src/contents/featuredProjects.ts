...
export const featuredProjects: Project[] = [
   {
      ...
      {
        title: 'EliteShop',
        description: 'EliteShop is a modern, responsive E-commerce Frontend featuring a clean UI, product catalog, shopping cart, checkout, authentication, and order history, all managed on the client side',
